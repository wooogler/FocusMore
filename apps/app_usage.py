...
@app.callback(Output("FocusBar", "figure"), Input("selectDay", "value"))
...
@app.callback(Output("appPie1", "figure"), Input("selectDay", "value"))
...
@app.callback(Output("appPie2", "figure"), Input("selectDay", "value"))
def update_pie1_graph(selectedValue):
